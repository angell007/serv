...
<div class="row">
    ...
    <div class="col-md-6">
      ...
      <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'marital_status_id') !!}">
			<label for="">Estado educativo</label>
    ...
    <div class="col-md-12">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'street_address') !!}">
			...
			{!! Form::textarea('street_address', null, array('class'=>'form-control textC ', 'id'=>'street_address', 'placeholder'=>__('Street Address'))) !!}
 ...
 <div class="col-md-6">
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'current_salary') !!}">
			...
			{!! Form::text('current_salary', null, array('class'=>'form-control number-1', 'id'=>'current_salary', 'placeholder'=>__('Current Salary'))) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'expected_salary') !!}">
			...
			{!! Form::text('expected_salary', null, array('class'=>'form-control number-1', 'id'=>'expected_salary', 'placeholder'=>__('Expected Salary'))) !!}
