<div class="modal-body">
    <div class="form-body">
        ...
        <div class="form-group" id="div_degree_type_id">
            <label for="degree_type_id" class="bold"> Tipo </label>
            <?php
            $degree_type_id = (isset($profileEducation) ? $profileEducation->degree_type_id : null);
            ?>
            <span id="degree_types_dd">
                {!! Form::select('degree_type_id', [''=>'Seleccione tipo'], $degree_type_id, array('class'=>'form-control', 'id'=>'degree_type_id')) !!}
            </span>
            <span class="help-block text-danger degree_type_id-error"></span>
        </div>
        ...
        <div class="form-group" id="div_degree_result">
            <label for="degree_result" class="bold">Titulo obtenido</label>
            <input class="form-control" id="degree_result" placeholder="Titulo obtenido" name="degree_result" type="text" value="{{(isset($profileEducation)? $profileEducation->degree_result:'')}}">
        ...
        <div class="form-group" id="div_result_type_id">
            <label for="result_type_id" class="bold">Tipo</label>
            <?php
            $result_type_id = (isset($profileEducation) ? $profileEducation->result_type_id : null);
            ?>
            {!! Form::select('result_type_id', [''=>'Seleccione tipo']+$resultTypes, $result_type_id, array('class'=>'form-control', 'id'=>'result_type_id')) !!}
