...
<div class="row">
    ...
    <!--<div class="col-md-6">-->
    <!--    <div class="formrow {!! APFrmErrHelp::hasError($errors, 'gender_id') !!}" id="gender_id_div"> {!! Form::select('gender_id', ['' => __('Gender')]+$genders, null, array('class'=>'form-control', 'id'=>'gender_id')) !!}-->
    ...
    <div class="col-md-6">
        <label class="radio-inline">Mostrar informacion de la empresa
        ...
        if (country_id != '') {
            $.post("{{ route('filter.lang.states.dropdown') }}", {
                ...
                .done(function(response) {
                    var options = response.replace('<select id="state_id" class="form-control" name="state_id">', '')
    ...
    function filterLangCities(city_id) {
        ...
        if (state_id != '') {
            $.post("{{ route('filter.lang.cities.dropdown') }}", {
                ...
                .done(function(response) {
                    var options = response.replace('<select id="city_id" class="form-control" name="city_id">', '')
                    options = options.replace('</select>', '')
