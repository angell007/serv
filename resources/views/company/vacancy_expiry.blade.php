    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9 col-sm-8"> 
                <div class="myads">
                    <h3>Ofertas laborales cuya fecha de expiración ya ha pasado y debes cerrar.</h3>
                    <br>
                    <ul class="searchList">
                        <!-- job start --> 
                        ...
                        <li id="job_li_{{$job->id}}">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4"> 
                                    <div>
                                        <form action="{{route('company.close_process')}}" method="POST">
                                            @csrf

                                            <input type="hidden" name="job" value="{{$job->id}}">
                                        
                                            <label for="mensaje">Describe por que no hubo contratación:</label>
                                            <textarea  class="form-control" name="mensaje" minlength="1" id="mensaje" cols="30" rows="5" required></textarea>
                                        
                                            <button  class="btn btn-info btn-sm" type="submit">Cerrar proceso de la oferta</button>
                                        </form>
                                    </div>
