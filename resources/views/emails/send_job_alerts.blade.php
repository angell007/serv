            ...
            <tr>
                <td align="center">
                    <table border="0" align="center" width="590" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tbody>
                                    <tr>
                                        <td>
                                            <a href="{{ route('job.detail', $job->slug) }}"
                                                style="text-decoration:none;font:bold 16px/20px HelveticaNeue,Helvetica,Arial,sans-serif;color:#00c;padding:0 0 5px"
                                                target="_blank"
                                                data-saferedirecturl="https://www.google.com/url?q={{ route('job.detail', $job->slug) }}">{{ $job->title }}</a>

                                        </td>
                                    </tr>
                                    <tr>
                                        <td
                                            style="font:15px/18px HelveticaNeue,Helvetica,Arial,sans-serif;color:#6f6f6f;padding:0 0 4px">
                                    ...
                                    <tr>
                                        <td class="m_-2367700890496463653job-info-snippet"
                                            style="font:13px/18px HelveticaNeue,Helvetica,Arial,sans-serif;color:#000;padding:0 0 3px">
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <tr>
                            <td height="40" style="font-size: 1rem; line-height: 1rem;">

                                {{ strip_tags($message_c) ?? '' }}</td>
                        </tr>
