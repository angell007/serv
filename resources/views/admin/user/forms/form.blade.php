...
<div class="form-body">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'last_name') !!}">
        {!! Form::label('last_name', 'Apellidos', ['class' => 'bold']) !!}
        {!! Form::text('last_name', null, array('class'=>'form-control', 'id'=>'last_name', 'placeholder'=>'Apellidos')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'gender_id') !!}">
        ...
        {!! Form::select('gender_id', [''=>'Seleccione Genero']+$genders, null, array('class'=>'form-control', 'id'=>'gender_id')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'marital_status_id') !!}">
        ...
        {!! Form::select('marital_status_id', [''=>'Seleccione Estado civil']+$maritalStatuses, null, array('class'=>'form-control', 'id'=>'marital_status_id')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'national_id_card_number') !!}">
        {!! Form::label('national_id_card_number', 'Numero de identificación', ['class' => 'bold']) !!}
        {!! Form::text('national_id_card_number', null, array('class'=>'form-control', 'id'=>'national_id_card_number', 'placeholder'=>'Numero de identificación')) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'phone') !!}">
        {!! Form::label('phone', 'Telefono', ['class' => 'bold']) !!}
        {!! Form::text('phone', null, array('class'=>'form-control', 'id'=>'phone', 'placeholder'=>'Telefono')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'phone') !!}
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'mobile_num') !!}">
        {!! Form::label('mobile_num', 'Numero de celular', ['class' => 'bold']) !!}
        {!! Form::text('mobile_num', null, array('class'=>'form-control', 'id'=>'mobile_num', 'placeholder'=>'Numero de celular')) !!}
